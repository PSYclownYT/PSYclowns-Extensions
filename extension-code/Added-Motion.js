...
/* generated l10n code */Scratch.translate.setup({"it":{"_Stretch":"Stira","_change stretch by x: [DX] y: [DY]":"cambia deformazione di x: [DX] y: [DY]","_change stretch x by [DX]":"cambia deformazione x di [DX]","_change stretch y by [DY]":"cambia deformazione y di [DY]","_set stretch to x: [X] y: [Y]":"imposta deformazione a x: [X] y: [Y]","_set stretch x to [X]":"porta deformazione x a [X]","_set stretch y to [Y]":"porta deformazione y a [Y]","_x stretch":"deformazione x","_y stretch":"deformazione y"},"nl":{"_Stretch":"Rekken","_change stretch by x: [DX] y: [DY]":"verander uitrekking met x: [DX] y: [DY]","_change stretch x by [DX]":"verander x-uitrekking met [DX]","_change stretch y by [DY]":"verander y-uitrekking met [DY]","_set stretch to x: [X] y: [Y]":"stel uitrekking in op x: [X] y: [Y]","_set stretch x to [X]":"maak x-uitrekking [X]","_set stretch y to [Y]":"maak y-uitrekking [Y]","_x stretch":"x-uitrekking","_y stretch":"y-uitrekking"},"ru":{"_Stretch":"Растяжение","_change stretch by x: [DX] y: [DY]":"изменить растяжение на x: [DX] y: [DY]","_change stretch x by [DX]":"изменить растяжение x на [DX]","_change stretch y by [DY]":"изменить растяжение y на [DY]","_set stretch to x: [X] y: [Y]":"задать растяжение в x: [X] y: [Y]","_set stretch x to [X]":"задать растяжение x в [X]","_set stretch y to [Y]":"задать растяжение y в [Y]","_x stretch":"растяжение x","_y stretch":"растяжение y"},"zh-cn":{"_Stretch":"伸缩","_change stretch by x: [DX] y: [DY]":"角色的x轴伸缩比例增加[DX]，y轴伸缩比例增加[DY]","_change stretch x by [DX]":"x轴伸缩比例增加[DX]","_change stretch y by [DY]":"y轴伸缩比例增加[DY]","_set stretch to x: [X] y: [Y]":"设置角色的x轴伸缩比例为[X]，y轴伸缩比例为[Y]","_set stretch x to [X]":"设置x轴伸缩比例为[X]","_set stretch y to [Y]":"设置y轴伸缩比例为[Y]","_x stretch":"x轴伸缩比例","_y stretch":"y轴伸缩比例"}});/* end generated l10n code */(function (Scratch) {
  "use strict";
